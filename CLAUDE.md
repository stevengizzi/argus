...
**Audit Phase 3 remediation (`audit-2026-04-21`).** FIX-00/15/17/20/01/11/02/12/03/21 landed; remaining FIX-NN sessions queued. Post-31.9 component-ownership refactor scheduled (DEF-175). 22 shadow variants still collecting CounterfactualTracker data. Next production sprint: **31B (Research Console / Variant Factory)**.
...
- **Tests:** 4,965 pytest + 859 Vitest (as of FIX-14). Known flakes: DEF-150 (time-of-day arithmetic, first 2 min of every hour) + DEF-163 (timezone-boundary + hardcoded dates) + DEF-171 (ibkr_broker xdist). All batched into FIX-13. Treat as pre-existing.
