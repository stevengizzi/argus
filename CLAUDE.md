...
- **Tests:** 4,985 pytest + 859 Vitest (as of FIX-04). Known flakes: DEF-150 (time-of-day arithmetic, first 2 min of every hour) + DEF-167 (Vitest hardcoded-date decay remainder) + DEF-171 (ibkr_broker xdist). All batched into FIX-13. Treat as pre-existing.
