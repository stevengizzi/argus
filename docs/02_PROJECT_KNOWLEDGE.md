...
> *Paste this into Claude's project instructions. Keep updated as the project evolves. Last updated: Feb 28, 2026.*
...
**Build Track:** 1712 tests (pytest) + 257 (Vitest). Sprints 1–21d complete. Sprint 22 (AI Layer MVP) is NEXT.
...
- Sprint 21.5 (Live Integration): **IN PROGRESS** — Databento + IBKR live connection, end-to-end validation, first live market sessions. 13-16 sessions planned across 4 phases (Databento activation, IBKR paper activation, end-to-end integration, stability). See Sprint 21.5 spec. DEC-230 through DEC-236.
