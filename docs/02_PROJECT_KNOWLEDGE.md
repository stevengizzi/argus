...
- **Seven-page architecture (DEC-169):** Dashboard (ambient), Trade Log (history), Performance (analytics), Orchestrator (operations/controls), Pattern Library (strategy encyclopedia), The Debrief (knowledge/research), System (infrastructure health). **6 of 7 built** (The Debrief remaining — Sprint 21c). Desktop icon sidebar grouped by concern. Mobile 6-tab with abbreviated labels (DEC-189).
...
- **Keyboard shortcuts extended to 1–5 (DEC-180):** Dynamic NAV_ITEMS.length mapping. Pattern Library is 5th page. Amends DEC-151.
