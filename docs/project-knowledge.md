...
> *Tier A operational context for Claude Code and Claude.ai. Last updated: March 28, 2026 (Sprint 27.95 doc sync — Broker Safety + Overflow Routing).*
...
**Sprints completed:** 1 through 27 + 21.6 + 25.9 + 27.5 + 27.6 + 27.65 + 27.7 + 27.75 + 27.8 + 27.9 + 27.95 (29 full sprints + 34 sub-sprints)
...
├── config/         # YAML config files (system.yaml, system_live.yaml, strategies/, regime.yaml, counterfactual.yaml)
└── tests/          # pytest + Vitest
```
