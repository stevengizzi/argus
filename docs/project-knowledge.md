...
> *Tier A operational context for Claude Code and Claude.ai. Last updated: March 24, 2026 (Sprint 27.5 doc sync — Evaluation Framework).*
...
**Sprints completed:** 1 through 27 + 21.6 + 25.9 + 27.5 (28 full sprints + sub-sprints)
...
| `docs/sprint-history.md` | Complete sprint history (1–27 + 21.6 + 25.9 + 27.5) |
