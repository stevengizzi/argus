...
> *Tier A operational context for Claude Code and Claude.ai. Last updated: March 29, 2026 (Sprint 28 doc sync — Learning Loop V1).*
...
**Tests:** ~3,837 pytest + 680 Vitest (0 failures in Vitest, 8 pre-existing pytest failures)
**Sprints completed:** 1 through 28 + 21.6 + 25.9 + 27.5 + 27.6 + 27.65 + 27.7 + 27.75 + 27.8 + 27.9 + 27.95 (30 full sprints + 34 sub-sprints)
...
├── config/         # YAML config files (system.yaml, system_live.yaml, strategies/, regime.yaml, counterfactual.yaml, learning_loop.yaml)
└── tests/          # pytest + Vitest
```
...
| `docs/sprint-history.md` | Complete sprint history (1–27 + 21.6 + 25.9 + 27.5 + 27.6 + 27.65 + 27.7 + 27.75 + 27.8 + 27.9 + 27.95) |
