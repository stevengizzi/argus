...
> *Tier A operational context for Claude Code and Claude.ai. Last updated: March 25, 2026 (Sprint 27.7 doc sync — Counterfactual Engine).*
...
**Tests:** ~3,517 pytest + 633 Vitest (0 failures, 0 hangs)
...
| `docs/decision-log.md` | All 368 DEC entries with full rationale (0 new in Sprint 27.7 — all patterns followed established precedent) |
| `docs/dec-index.md` | Quick-reference DEC index with status |
| `docs/sprint-history.md` | Complete sprint history (1–27 + 21.6 + 25.9 + 27.5 + 27.6 + 27.65 + 27.7) |
