...
> *Tier A operational context for Claude Code and Claude.ai. Last updated: March 30, 2026 (Sprint 28.75 doc sync — Post-Session Operational + UI Fixes).*
...
**Sprints completed:** 1 through 28.75 + 21.6 + 25.9 + 27.5 + 27.6 + 27.65 + 27.7 + 27.75 + 27.8 + 27.9 + 27.95 (30 full sprints + 36 sub-sprints)
...
├── config/         # YAML config files (system.yaml, system_live.yaml, strategies/, regime.yaml, counterfactual.yaml, learning_loop.yaml, exit_management.yaml)
└── tests/          # pytest + Vitest
```
...
| `docs/decision-log.md` | All 381 DEC entries with full rationale (4 new in Strategic Check-In March 30: DEC-378–381) |
| `docs/dec-index.md` | Quick-reference DEC index with status |
| `docs/sprint-history.md` | Complete sprint history (1–28.5 + 21.6 + 25.9 + 27.5 + 27.6 + 27.65 + 27.7 + 27.75 + 27.8 + 27.9 + 27.95) |
