...
> *Tier A operational context for Claude Code and Claude.ai. Last updated: March 26, 2026 (Sprint 27.8 doc sync — Operational Cleanup + Validation Tooling).*
...
**Sprints completed:** 1 through 27 + 21.6 + 25.9 + 27.5 + 27.6 + 27.65 + 27.7 + 27.75 + 27.8 + 27.9 (29 full sprints + 33 sub-sprints)
...
| `docs/decision-log.md` | All 368 DEC entries with full rationale (0 new in Sprints 27.7/27.75 — all patterns followed established precedent) |
| `docs/dec-index.md` | Quick-reference DEC index with status |
| `docs/sprint-history.md` | Complete sprint history (1–27 + 21.6 + 25.9 + 27.5 + 27.6 + 27.65 + 27.7 + 27.75 + 27.8) |
