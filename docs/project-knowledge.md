...
> *Tier A operational context for Claude Code and Claude.ai. Last updated: April 1, 2026 (Sprint 29.5 doc sync — Post-Session Operational Sweep).*
...
**Sprints completed:** 1 through 29 + 21.6 + 25.9 + 27.5 + 27.6 + 27.65 + 27.7 + 27.75 + 27.8 + 27.9 + 27.95 + 28.5 + 28.75 + 29.5 (31 full sprints + 38 sub-sprints)
**Active sprint:** 32 (Parameterized Templates + Experiment Pipeline — merged 32+32.5 per April 1 planning session, 8 sessions)
...
~~26~~ ✅ → ~~27~~ ✅ → ~~21.6~~ ✅ → ~~25.9~~ ✅ → ~~27.5~~ ✅ → ~~27.6~~ ✅ → ~~27.7~~ ✅ → ~~27.75~~ ✅ → ~~27.8~~ ✅ → ~~27.9~~ ✅ → ~~27.95~~ ✅ → ~~28~~ ✅ → ~~28.5~~ ✅ → ~~28.75~~ ✅ → ~~29~~ ✅ → ~~29.5~~ ✅ → **32 (Parameterized Templates + Experiment Pipeline — merged 32+32.5, 8 sessions)** → 31A (Pattern Expansion III — reach 15 strategies) → 30 (Short Selling + Parabolic Short — deferred until longs profitable) → 31.5 (Parallel Sweep Infrastructure) → 31B (Research Console — deferred per DEC-379) → 33 (Statistical Validation) → **33.5 (Adversarial Stress Testing)** → 34–35 (Systematic Search ★, Ensemble Analysis) → 36–42 (Cross-Family Search, Ensemble Orchestrator V2, Synapse, Learning Loop V2, Continuous Discovery, Performance Workbench). Sprint 32 absorbs Sprint 32.5 scope per April 1 planning session (experiment registry, variant spawning, backtest pre-filter, promotion evaluator all included). CPA consultation removed from all gates per DEC-380. Tax Intelligence Automation added to post-revenue horizon (DEC-380). Order Flow Model deferred to post-revenue (DEC-238). Historical data purchase deferred indefinitely (DEC-353); 96 months of OHLCV-1m available at $0 via XNAS.ITCH + XNYS.PILLAR (DEC-358). Full roadmap: `docs/roadmap.md`.
...
**Completed infrastructure:** Setup Quality Engine (**Sprint 24 ✅**), NLP Catalyst Pipeline (**Sprint 23.5 ✅**), Dynamic Position Sizer (**Sprint 24 ✅**), Evaluation Framework (**Sprint 27.5 ✅**), Regime Intelligence (**Sprint 27.6 ✅**), Counterfactual Engine (**Sprint 27.7 ✅**), Learning Loop V1 (**Sprint 28 ✅**), Exit Management (**Sprint 28.5 ✅**), Pattern Expansion I (**Sprint 29 ✅** — 12 active strategies), BacktestEngine (**Sprint 27 ✅**), MFE/MAE tracking (**Sprint 29.5 ✅**).

**Next:** Sprint 32 (Parameterized Templates + Experiment Pipeline — merged 32+32.5), then 31A (Pattern Expansion III → 15 strategies), 30 (Short Selling — deferred until longs profitable), 33 (Statistical Validation), 33.5 (Adversarial Stress Testing), 34–35 (Systematic Search + Ensemble), 36–42 (Discovery Pipeline, Ensemble V2, Synapse, Learning Loop V2, Continuous Discovery, Performance Workbench). Order Flow Model deferred to post-revenue (DEC-238). Full roadmap: `docs/roadmap.md`.
...
| `docs/decision-log.md` | All 381 DEC entries with full rationale (no new DECs in Sprint 29 — all design decisions followed established patterns) |
| `docs/dec-index.md` | Quick-reference DEC index with status |
| `docs/sprint-history.md` | Complete sprint history (1–29 + 21.6 + 25.9 + 27.5 + 27.6 + 27.65 + 27.7 + 27.75 + 27.8 + 27.9 + 27.95 + 28.5 + 28.75) |
