...
- **#3 (modifyOrder determinism):** unverified at Phase C; falsifying spike
  (adversarial sub-axes) scheduled in S1a per Decision 1. Worst-axis Wilson
  UB drives halt-or-proceed gate per Hypothesis Prescription. Operator chose
  ...
  Round 3 re-litigation candidate).
