...
> **Campaign HEAD:** *pending IMPROMPTU-05 commit* (prior: `a50ac8d` IMPROMPTU-CI)
...
| Stage 9B | IMPROMPTU-05 (deps & infra — ✅ LANDED; commit *pending*), IMPROMPTU-06 (test-debt), IMPROMPTU-07 (doc-hygiene + UI), IMPROMPTU-08 (architecture.md catalog) | 🚧 PARTIAL |
