...
>
> **Last updated:** 2026-04-23 — IMPROMPTU-CI landed (DEF-200 opened + closed; DEF-193 closed — both share the same observatory_ws push-loop root cause)
> **Campaign HEAD:** `a50ac8d` (IMPROMPTU-CI commit)
> **Workflow submodule:** `942c53a`
> **Baseline tests:** 5,054 pytest (local; +2 from IMPROMPTU-CI regression tests — grep-guard + behavioral) / CI pending green on IMPROMPTU-CI fix commit + 859 Vitest
