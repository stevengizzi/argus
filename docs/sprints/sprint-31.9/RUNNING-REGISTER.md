...
>
> **Last updated:** 2026-04-23 — IMPROMPTU-07 landed (DEF-164/169/189/191/198 closed + Apr 21 F-05/F-06/F-08 residuals + cosmetics X1–X6 + shadow-variant badge + CLAUDE.md variant-count methodology note; boot grace config + DEF-189 param-name-map + F-06 REST enrichment with additive `mfe_r`/`mae_r` + ULID 8→12 char + F-08 warning→debug downgrade; pytest 5057→5073 (+16), Vitest 859→866 (+7))
> **Campaign HEAD:** `489cb3f` (IMPROMPTU-07 post-session register cleanup; code `add4e83`, review CLEAR `add4e83`+`489cb3f`; CI run 24860817762 green; prior: `0918722` IMPROMPTU-06 post-session register cleanup)
