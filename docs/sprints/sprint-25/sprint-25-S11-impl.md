# Sprint 25, Session 11: Integration Polish + Keyboard Refinement
...
- [ ] Tier 2 review via @reviewer → `docs/sprints/sprint-25/session-11-review.md`
...
## Close-Out
Follow close-out skill. Write to: `docs/sprints/sprint-25/session-11-closeout.md`
...
2. Close-out: `docs/sprints/sprint-25/session-11-closeout.md`
...
Write review to: `docs/sprints/sprint-25/session-11-review.md`
